...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--codec", default="h264_nvenc", help="libx264, libx265, h264_nvenc, or hevc_nvenc")
    parser.add_argument("--crf", type=int, default=32, help="quality value; lower is larger/better")
